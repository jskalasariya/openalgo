...
from strategies.nifty_sehwag.strategy import NiftySehwagStrategy, is_market_open
from strategies.nifty_sehwag.logging_manager import get_logging_manager, get_main_logger
...
def run_strategy_main_loop():
    ...
    """
    # Initialize logging manager (creates date-based folders)
    get_logging_manager()
    logger = get_main_logger()

    logger.info("\n" + "="*70)
    logger.info("🚀 Nifty Sehwag Strategy v3.0 (Clean & Modular)")
    logger.info("="*70 + "\n")
